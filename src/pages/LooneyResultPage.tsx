  ...
  return <div className="flex min-h-screen flex-col">
    ...
    <main className="flex-grow cow-grid-bg bg-background px-4 pb-20 pt-28">
      <div className="container mx-auto max-w-6xl">
        ...
        {loading ? <div className="pixel-corners mx-auto mt-10 max-w-lg border-2 border-cow-purple/40 bg-cow-purple/5 p-6 text-center"><IconLoader2 className="mx-auto h-8 w-8 animate-spin text-cow-purple" /><p className="mt-4 text-sm text-muted-foreground">Loading this Looney check...</p></div>
