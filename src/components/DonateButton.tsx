      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-lg border-2 border-cow-purple bg-gradient-to-b from-background to-background/95 backdrop-blur-sm max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Help us keep providing free resources and tools for the Minecraft content creation community.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="flex flex-col space-y-2">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2">
                    ...
                    <span>Keep all resources 100% free</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Sparkles className="h-4 w-4 text-cow-purple" />
                  ...
                  <li className="flex items-center gap-2">
                    <Sparkles className="h-4 w-4 text-cow-purple" />
                    <span>Support the creator community</span>
                  </li>
                </ul>
              </div>
